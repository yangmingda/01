...
<div class="main">
    ...
    <p class="short-input ue-clear">
    	<label>作者：</label>
        <input name="author" type="text" value="<?php echo ($data["author"]); ?>" placeholder="作者..." value="{}"/>
    </p>
    <p class="short-input ue-clear">
    	<label>内容：<script name="content" type="text/plain" id="myEditor" style="width:666px;height:i;"><?php echo (htmlspecialchars_decode($data["content"])); ?></script></label>
