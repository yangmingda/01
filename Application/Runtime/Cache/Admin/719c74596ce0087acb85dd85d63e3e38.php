	...
	<table>
        ...
        <tbody>
        	<?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
				...
				<td class="file"><?php echo ($vo["filename"]); if($vo["hasfile"] == 1): ?><a href="javascript:;" class="download" data="<?php echo ($vo["id"]); ?>">【下载】</a><?php endif; ?></td>
                <td class="content"><?php echo (msubstr($vo["content"],0,20)); ?></td>
                <td class="addtime"><?php echo (date('Y-m-d H:i:s',$vo["addtime"])); ?></td>
                <td class="status"><?php if($vo["isread"] == 0): ?>未读<?php else: ?>已读<?php endif; ?></td>
                <td class="operate">
                	<a href ="/index.php/Admin/Email/del/id/<?php echo ($vo["id"]); ?>">删除</a> |
